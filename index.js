...
window.onload = function() {
    //As the window loads, all the stuff below this becomes functional
        ...
        var clock1 = setInterval(depleteH, 320); //Hunger decrement speed
        var bladder = 100; //Bladder stat
        var clock2 = setInterval(depleteB, 320); //Bladder decrement speed
        var fun = 100; //Fun stat
        var clock3 = setInterval(depleteF, 300); //Fun decrement stat
